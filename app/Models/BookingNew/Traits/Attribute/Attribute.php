<?php namespace App\Models\BookingNew\Traits\Attribute;
...
use File;
use App\Repositories\BookingNew\EloquentBookingNewRepository;
...
trait Attribute
{
	...
	{
		$repository = new EloquentBookingNewRepository;
